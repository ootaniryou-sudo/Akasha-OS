...
export class BinaryCodec {
  ...
  static encode(
    buf: ArrayBuffer,
    header: Omit<PacketHeaderView, 'magic' | 'version' | 'payloadLen'> & {
  ...
  static decodeHeader(buf: ArrayBuffer, byteLength = buf.byteLength): PacketHeaderView {
...
export function buildComputeHeader(
  ...
  seq: number,
  flags = Flag.NONE,
): Omit<PacketHeaderView, 'magic' | 'version' | 'payloadLen'> {
  return {
